...
normalProducts = {
    ...
    'reviews': ["Customers find this cleanser effective for daily use, noting it removes dirt without stripping moisture. Its gentle formula leaves the skin soft and refreshed, and people appreciate the smooth texture. Some users say it feels slightly too light for deep cleansing, but most consider it reliable for normal skin.",
...
dryProducts = {
    ...
    'reviews': ["Customers find this cream extremely hydrating and long-lasting, often restoring moisture overnight. The rich texture absorbs well without greasiness. Some dislike the tub packaging, but most prioritize its strong performance.",
